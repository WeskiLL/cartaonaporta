  ...
  const products = [
    {
      ...
      placeholder: "[Imagem do produto 1]",
    },
    {
      id: 2,
      name: "Tag para Semijoias",
      description: "Material premium que valoriza cada peça da sua coleção.",
      placeholder: "[Imagem do produto 2]",
    },
    {
      id: 3,
      name: "Tag para Joias",
      description: "Acabamento sofisticado para joias de alto padrão.",
      placeholder: "[Imagem do produto 3]",
    },
    {
      id: 4,
      name: "Cartões de Visita",
      description: "Cartões profissionais que reforçam sua marca.",
      placeholder: "[Imagem do produto 4]",
    },
    {
      id: 5,
      name: "Tags Personalizadas",
      description: "Crie tags únicas com seu logotipo e design.",
      placeholder: "[Imagem do produto 5]",
    },
    {
      id: 6,
      name: "Kit Lojista",
      description: "Pacote completo para profissionalizar sua loja.",
      placeholder: "[Imagem do produto 6]",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            ...
            >
              {/* Image Placeholder */}
              <div className="aspect-[4/3] bg-gradient-to-br from-accent to-muted relative overflow-hidden">

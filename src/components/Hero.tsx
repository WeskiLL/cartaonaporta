      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="mt-10 pt-8 border-t border-border animate-fade-up" style={{
              ...
              <div className="flex flex-wrap gap-6 justify-center lg:justify-start">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-foreground">Envio para todo Brasil</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="relative animate-fade-up" style={{
            ...
            <div className="relative bg-card rounded-3xl shadow-brand-lg p-4 border border-border">
              <div className="aspect-square rounded-2xl overflow-hidden">
                <img 
                  src={heroImage} 
                  alt="Tags personalizadas para joias e bijuterias" 

          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-up" style={{ animationDelay: "0.3s" }}>
              <Button variant="hero" size="xl" asChild>
                <a
                  href="https://wa.me/5574981138033?text=Olá! Vim pelo site e gostaria de saber mais sobre as tags personalizadas."
                  target="_blank"
            ...
            {/* Trust Indicators */}
            <div className="mt-10 pt-8 border-t border-border animate-fade-up" style={{ animationDelay: "0.4s" }}>
